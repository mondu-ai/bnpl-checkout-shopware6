...
class MonduOrderConfirmedEvent implements ShopwareEvent, OrderAware, MailAware, SalesChannelAware, FlowEventAware, CustomerAware, CustomerGroupAware
{
    public const EVENT_NAME = 'Mondu Payments.order.Confirmed';
